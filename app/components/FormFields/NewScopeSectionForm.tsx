...
import { NewScopeSectionFormProps } from '../../types/template';

export default function NewScopeSectionForm({
  scopeSections = [],
  formLabelClass,
  formFieldClass,
  ...
  removeScopeSection,
  addUpdate
}: NewScopeSectionFormProps) {
  return (
    <div>
      <h4 className="text-l font-bold mb-4">New Scope Sections</h4>
