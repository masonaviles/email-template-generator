...
const customTemplateName = 'Dev: Cut ic Branch Email';

export default function CutIcBranchEmailTemplate() {
  const { templateData } = useTemplateContext(); // Access context data

  return (
    <>
    <h2 className="text-xl font-bold mb-4">Cut ic Branch Email Template</h2>
    <div className="text-sm bg-gray-50 p-4 rounded-md shadow-inner whitespace-pre-wrap break-words">
        <pre className="whitespace-pre-wrap break-words">
      
        SUBJECT : <br/>
        {templateData.projectName || '[Project Name]'} : Cut ic Branch<br/><br/>

        Hello,<br/><br/>

        Approval is now with you to please cut ic [IC NUMBER] for {templateData.projectName || '[Project Name]'}. <br/><br/>

        Project details provided, below. Targeting Dev kick-off on {formatDate(templateData.kickoffDate) || '[Kickoff Date]'}.<br/><br/>
