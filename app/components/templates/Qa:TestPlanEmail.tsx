...
const customTemplateName = 'QA: QA Test Plan Email';

export default function TestPlanEmailTemplate() {
  const { templateData } = useTemplateContext(); // Access context data

  return (
    <>
    <h2 className="text-xl font-bold mb-4">Test Plan Email Template</h2>
    <div className="text-sm bg-gray-50 p-4 rounded-md shadow-inner whitespace-pre-wrap break-words">
        <pre className="whitespace-pre-wrap break-words">

            SUBJECT : <br/>
            {templateData.projectName || '[Project Name]'} : Test Plan Request<br/><br/>

            Hello,<br/><br/>

            Below, please find the project details for {templateData.projectName || '[Project Name]'} for the test plan.  <br/><br/>

            Targeting to have this over to [MARCOM QA LEAD] for review by [DATE]. <br/><br/>
