...
export default function InteractiveKickoffEmailTemplate() {
  const { templateData } = useTemplateContext(); // Access context data

  return (
    <>
    <h2 className="text-xl font-bold mb-4">Interactive Kick-off Email Template</h2>
    <div className="text-sm bg-gray-50 p-4 rounded-md shadow-inner whitespace-pre-wrap break-words">
        <pre className="whitespace-pre-wrap break-words">

        SUBJECT : <br/>
        {templateData.projectName || '[Project Name]'} : Interactive Kick-off<br/><br/>

        Hello,<br/><br/>

        Below, please find the project details for {templateData.projectName || '[Project Name]'} — also available on Quip, Apple Box, and Server.  <br/><br/>

        I will walk everyone through the updates in our Interactive Kick-off Meeting scheduled for [DATE and TIME]. <br/><br/>
        ...
        Interactive Brief:<br/>
        AppleBox: [APPLEBOX LINK]<br/>
        Server: [SERVER LINK]<br/><br/>

        Interactive Schedule:<br/>
        Quip: [QUIP LINK]<br/>
        AppleBox: [APPLEBOX LINK]<br/>
        Server: [SERVER LINK]<br/><br/>
